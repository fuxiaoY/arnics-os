...
{                                                                                     \
    ...
    {FAL_PART_MAGIC_WORD, PARTITION_NAME_ARNICS_SYS_PARA,      NOR_FLASH_DEV_NAME,          DATAFLASH_ARNICS_SYS_PARA_START_ADDR, DATA_FALSH_SIZE_ARNICS_SYS_PARA, 0}, \
    {FAL_PART_MAGIC_WORD, PARTITION_NAME_SYSTEM_CFG_PARA,      NOR_FLASH_DEV_NAME,          DATAFLASH_SYS_CFG_PARA_START_ADDR, DATA_FALSH_SIZE_SYSTEM_CFG_PARA, 0}, \
    {FAL_PART_MAGIC_WORD, PARTITION_NAME_SYSTEM_STATUS_PARA,   NOR_FLASH_DEV_NAME,          DATAFLASH_SYS_STATUS_PARA_START_ADDR, DATA_FALSH_SIZE_SYSTEM_STATUS_PARA, 0}, \
    ...
    {FAL_PART_MAGIC_WORD,  "rolldb_kvdb",                      NOR_FLASH_DEV_NAME,          DATAFLASH_DB_ADDR, DATAFLASH_SIZE_DB, 0}, \
    {FAL_PART_MAGIC_WORD,  "rolldb_tsdb",                      NOR_FLASH_DEV_NAME,          DATAFLASH_LOG_ADDR, DATAFLASH_SIZE_LOG, 0}, \
}
